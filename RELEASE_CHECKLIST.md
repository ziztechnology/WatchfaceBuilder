...
### 5. GitHub 准备
- [ ] 创建 GitHub 仓库: https://github.com/ziztechnology/WatchfaceBuilder
- [ ] 推送代码到 GitHub
- [ ] 创建第一个 Release
- [ ] 上传预构建的二进制文件
...
# 添加远程仓库
git remote add origin https://github.com/ziztechnology/WatchfaceBuilder.git
...
1. 访问 https://github.com/ziztechnology/WatchfaceBuilder/releases/new
2. 选择 tag: `v0.1.0`
